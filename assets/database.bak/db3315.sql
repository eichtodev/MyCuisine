...
--
-- Host: localhost    Database: mycuisine
-- ------------------------------------------------------
...
INSERT INTO `core_sites` VALUES (1,'Default Site','default','mycuisine.local',1,1425347530,0);
...
INSERT INTO `core_users` VALUES (1,'superadmin@mycuisine.com','eb86d3f3682600fc4f6ede3734a891339645f3fd','f54cb',1,'',1,'',1425347528,1425347528,'superadmin',NULL,NULL);
...
INSERT INTO `default_ci_sessions` VALUES ('684a77a9f07512cc8a17b145e9fb94b3','127.0.0.1','Mozilla/5.0 (X11; Linux x86_64; rv:34.0) Gecko/20100101 Firefox/34.0',1425376368,'a:7:{s:8:\"username\";s:10:\"superadmin\";s:5:\"email\";s:24:\"superadmin@mycuisine.com\";s:2:\"id\";s:1:\"1\";s:7:\"user_id\";s:1:\"1\";s:8:\"group_id\";s:1:\"1\";s:5:\"group\";s:5:\"admin\";s:17:\"flash:old:success\";s:25:\"Your settings were saved!\";}');
...
INSERT INTO `default_def_page_fields` VALUES (1,'2015-03-02 17:52:31',NULL,1,NULL,'<p>Welcome to our homepage. We have not quite finished setting up our website yet, but please add us to your bookmarks and come back soon.</p>'),(2,'2015-03-02 17:52:31',NULL,1,NULL,'<p>To contact us please fill out the form below.</p>\n				{{ contact:form name=\"text|required\" email=\"text|required|valid_email\" subject=\"dropdown|Support|Sales|Feedback|Other\" message=\"textarea\" attachment=\"file|zip\" }}\n					<div><label for=\"name\">Name:</label>{{ name }}</div>\n					<div><label for=\"email\">Email:</label>{{ email }}</div>\n					<div><label for=\"subject\">Subject:</label>{{ subject }}</div>\n					<div><label for=\"message\">Message:</label>{{ message }}</div>\n					<div><label for=\"attachment\">Attach  a zip file:</label>{{ attachment }}</div>\n				{{ /contact:form }}'),(3,'2015-03-02 17:52:31',NULL,1,NULL,'{{ search:form class=\"search-form\" }} \n		<input name=\"q\" placeholder=\"Search terms...\" />\n	{{ /search:form }}'),(4,'2015-03-02 17:52:31',NULL,1,NULL,'{{ search:form class=\"search-form\" }} \n		<input name=\"q\" placeholder=\"Search terms...\" />\n	{{ /search:form }}\n\n{{ search:results }}\n\n	{{ total }} results for \"{{ query }}\".\n\n	<hr />\n\n	{{ entries }}\n\n		<article>\n			<h4>{{ singular }}: <a href=\"{{ url }}\">{{ title }}</a></h4>\n			<p>{{ description }}</p>\n		</article>\n\n	{{ /entries }}\n\n        {{ pagination }}\n\n{{ /search:results }}'),(5,'2015-03-02 17:52:31',NULL,1,NULL,'<p>We cannot find the page you are looking for, please click <a title=\"Home\" href=\"{{ pages:url id=\'1\' }}\">here</a> to go to the homepage.</p>');
...
INSERT INTO `default_pages` VALUES (1,'home','','Home','home',0,'1','1',NULL,NULL,NULL,'',NULL,NULL,NULL,0,0,'live',1425347552,0,'',1,1,1425347552),(2,'contact','','Contact','contact',0,'1','2',NULL,NULL,NULL,'',NULL,NULL,NULL,0,0,'live',1425347552,0,'',0,1,1425347552),(3,'search','','Search','search',0,'1','3',NULL,NULL,NULL,'',NULL,NULL,NULL,0,0,'live',1425347552,0,'',0,1,1425347552),(4,'results','','Results','search/results',3,'1','4',NULL,NULL,NULL,'',NULL,NULL,NULL,0,0,'live',1425347552,0,'',0,0,1425347552),(5,'404','','Page missing','404',0,'1','5',NULL,NULL,NULL,'',NULL,NULL,NULL,0,0,'live',1425347552,0,'',0,1,1425347552);
...
INSERT INTO `default_users` VALUES (1,'superadmin@mycuisine.com','eb86d3f3682600fc4f6ede3734a891339645f3fd','f54cb',1,'',1,'',1425347528,1425376397,'superadmin',NULL,'6b25a438a95775043f1cf7cfffd99250a6daecf2');
...
-- Dump completed on 2015-03-03 17:15:54
